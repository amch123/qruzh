                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="owl-carousel owl-theme" data-plugin-options='{"items": 1}'>
                                <div>
                                    <div class="thumbnail">
                                        {{ Html::image('template/img/products/product-7.jpg') }}
                                    </div>
                                </div>
                                <div>
                                    <div class="thumbnail">
                                        {{ Html::image('template/img/products/product-7-2.jpg') }}
                                    </div>
                                </div>
                                <div>
                                    <div class="thumbnail">
                                        {{ Html::image('template/img/products/product-7-3.jpg') }}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <li>
                                            <div class="post-image">
                                                <div class="img-thumbnail">
                                                    <a href="#">
                                                        {{ Html::image('template/img/products/product-1.jpg', '', array('class' => 'img-responsive', 'width' => '111', 'height' => '54')) }}
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="post-info" style="padding-top:50px;">
                                                <span class="posted_in">Tienda: <a rel="tag" href="#">Regalos y más.</a></span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <span class="posted_in">Categorias: <a rel="tag" href="#">Accessories</a>, <a rel="tag" href="#">Bags</a>.</span>
                        ...
                        <div class="col-md-12">
                            <div class="tabs tabs-product">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#productReviews" data-toggle="tab">Comentarios (2)</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane" id="productReviews">
                                        <ul class="comments">
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail">
                                                        {{ Html::image('template/img/avatar-2.jpg', '', array('class' => 'avatar')) }}
                                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4 class="mb-md text-uppercase">Productos <strong>Relacionados</strong></h4>
